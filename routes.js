...
exports = module.exports = function (app, passport) {
    ...
    app.get('/events/details/:id', require('./views/events/index').details);
    app.get('/events/mine', require('./views/events/index').findMyEvents);
    
    // add events
    app.get('/events/add', require('./views/events/index').showAdd);
    app.post('/events/add', require('./views/events/index').add);
    
    // edit events
    app.get('/events/edit/:id', require('./views/events/index').showEdit);
    app.post('/events/edit/:id', require('./views/events/index').edit);
